          ...
          <>
            ...
            >
              <div className="flex items-start gap-10">
                ...
                <div className="h-40 border-1 border-gray-400 border-dashed"></div>

                <div className="flex items-start justify-between w-full">
                  <div className="flex-1">
                    <p className="font-normal text-lg">{order.title}</p>
                    <p className="text-sm text-gray-600">{order.format}</p>
              ...
              <div className="p-4 text-right">
                <p className="text-sm text-gray-500">
                  Ticket: {order.ticket.toFixed(2)} Convenience Fees: Rs
                  {order.fee.toFixed(2)}
                </p>
