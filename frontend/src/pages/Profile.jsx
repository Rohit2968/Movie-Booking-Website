            ...
            {activeTab === "Profile" && (
              <>
                ...
                <div className="bg-gradient-to-r from-gray-800 to-[#f74565] rounded-t-md px-6 py-6 flex items-center gap-6 text-white">
                  ...
                  <div className="mt-2">
                    <h2 className="text-2xl font-bold">Hi, Rohit Kumar</h2>
                ...
                <div className="bg-white p-6 mt-4 rounded-md">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="date"
                        className="w-full mt-1 border border-gray-200 rounded-lg px-3 py-2 cursor-pointer"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <button
                          className={`px-4 py-1 border border-gray-200 rounded-lg bg-white hover:bg-gray-400`}
                        >
                          Woman
                        </button>
                        <button
